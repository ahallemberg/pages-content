Veivett is a study tool for the Norwegian driving theory test, and the successor to [trafikkskiltene.no](https://trafikkskiltene.no), a site I built at fifteen. It covers the theory for car, motorcycle, moped and tractor: the syllabus written out topic by topic, a question bank where every answer is explained, spaced repetition for the signs, and mock exams with the same length and time limit as the real test. It is live at [veivett.no](https://veivett.no), currently in beta.
